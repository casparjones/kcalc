// Alpine.js App - Reactive state & UI logic (component factory)
...
export function createApp() {
    return {
            ...
            init: function () {
                ...
                dbReady.then(function (database) {
                    ...
                    // App-Daten geladen -> Ladebildschirm ausblenden
            ...
            exportAsPdf: function () {
                var self = this;
                this.dropdownOpen = false;
                // jsPDF (und html2canvas für den Diagramm-Export) bei Bedarf nachladen
                Promise.all([loadJsPDF(), loadHtml2Canvas()]).then(function () {
                try {
            ...
            toast: function (msg, type) {
                if (typeof Toastify === 'undefined') { setTimeout(() => this.toast(msg, type), 200); return; }
            ...
            confirmToast: function (msg, onConfirm) {
                if (typeof Toastify === 'undefined') { setTimeout(() => this.confirmToast(msg, onConfirm), 200); return; }
